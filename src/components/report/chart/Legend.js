...
const Legend = ({legendSelected, onLegendChange}) => {
        ...
        const colors = [
            ...
            '#fdf6de',
            '#024067',
            '#4e4c67','#63001c','#f1f0e1','#ffd038','#383d3b','#5d737e','#fa7921','#73d3dd','#fe9920','#354649','#2f4554','453354','#393d54','#61a0a8','#c4ccd3','#c24b30','#ca8622','#ab4d49','#d6605c','#efbfbe','#749f83','#91c7ae','#d48265','#e0a590','#a59792'];
